...
authRouter.get("/lookup", authenticate, UserService.findByEmail);
authRouter.post("/device-token", authenticate, validateBody(registerDeviceTokenSchema), UserService.registerDeviceToken);
authRouter.delete("/device-token", authenticate, UserService.unregisterDeviceToken);
...
authRouter.get("/users", authenticate, authorize("admin"), UserService.listUsers);
